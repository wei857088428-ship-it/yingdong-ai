...
type Overview = { xai: { configured: boolean; prepaidBalance: number | null; monthSpend: number | null; spendingLimit: number | null; error: string | null }; site: { users: number; totalCredits: number }; updatedAt: string };
