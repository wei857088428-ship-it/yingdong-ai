      ...
      <div className="storyboard-main">
        ...
        {shots.length > 0 && <div className="shot-section">
          ...
          <div className="shot-list">{shots.map((shot) => <article key={shot.shot_number}>
            ...
            <h3>{shot.scene}</h3><p><b>动作</b>{shot.action}</p>{shot.emotion && <p><b>情绪表演</b>{shot.emotion}</p>}{shot.dialogue && <p><b>对白/字幕</b>{shot.dialogue}</p>}{shot.error_message && <p className="shot-error"><b>错误</b>{shot.error_message}</p>}
